        ...
        <div class="card-header bg-body border-bottom p-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="d-flex flex-column flex-md-row gap-3 align-items-md-center">
                    ...
                    <button class="btn btn-primary btn-sm px-3 fw-semibold"><i class="bi bi-plus-lg me-1"></i>Tambah User Baru</button>
                </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr class="align-middle text-nowrap">
                            ...
                            <th class="text-center" style="width: 100px;">Login State</th>
